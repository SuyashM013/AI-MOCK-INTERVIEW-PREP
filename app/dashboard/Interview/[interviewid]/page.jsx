...
function Interview({ params }) {
  ...
  return (
    <div className='my-10 '>
      ...
      <h2 className='font-bebas text-5xl'>Let's Get Started</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">

        <div className="flex flex-col my-5 gap-5 ">

          <div className="flex flex-col font-montserrat gap-5 border p-5 rounded-lg">
          ...
          <div className="p-5 border font-montserrat  rounded-lg border-yellow-300 bg-yellow-100">
