...
const BoxGallery = () => {
  ...
  const boxes = [
    ...
    },
    {
      ...
      title: "Modern CV",
      description: "A clean and modern CV template with sleek design.",
      imageUrl: "/Resumes/resume12.jpg",
      fileUrl: "/resumes/resume12.docx",
